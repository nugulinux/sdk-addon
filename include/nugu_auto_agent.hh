...
public:
    ...
    void setPermission(PermissionType type, PermissionState state);
    std::string getPermissionTypeString(PermissionType type);
    std::string getPermissionStateString(PermissionState state);
...
private:
    ...
    INuguAutoListener* nugu_auto_listener;
    std::map<PermissionType, PermissionState> permission_map;
};
