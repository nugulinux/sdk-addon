...
NuguAutoAgent::NuguAutoAgent()
    ...
    , media_session(OSMediaSession::NONE)
{
...
void NuguAutoAgent::setMediaSession(OSMediaSession media_session)
{
    this->media_session = media_session;
}

std::string NuguAutoAgent::getMediaSessionString(OSMediaSession media_session)
{
    std::string media_session_str;

    switch (media_session) {
    case OSMediaSession::PLAYING:
        media_session_str = "PLAYING";
        break;
    case OSMediaSession::STOPPED:
        media_session_str = "STOPPED";
        break;
    case OSMediaSession::NONE:
        media_session_str = "NONE";
        break;
    }

    return media_session_str;
}
...
void NuguAutoAgent::updateInfoForContext(Json::Value& ctx)
{
    ...
    nugu_auto["mediaState"] = getMediaSessionString(media_session);
